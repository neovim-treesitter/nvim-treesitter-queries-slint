# nvim-treesitter-queries-slint

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-slint/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-slint/actions/workflows/validate.yml)

Neovim tree-sitter queries for **slint**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-slint",
...
- [ ] Changes are scoped to `slint` — do not include files for other languages
